...
export class AffindaAPI extends coreClient.ServiceClient {
  ...
  constructor(credentials: coreAuth.TokenCredential, options?: AffindaAPIOptionalParams) {
    ...
    const optionsWithDefaults = {
      ...
      endpoint: options.endpoint ?? options.baseUri ?? "https://{region}.affinda.com",
    };
...
const getAllWorkspaceMembershipsOperationSpec: coreClient.OperationSpec = {
  ...
  queryParameters: [Parameters.offset, Parameters.limit, Parameters.workspace, Parameters.user],
  urlParameters: [Parameters.region],
  headerParameters: [Parameters.accept],
  serializer,
};
...
const getDataFieldForCollectionOperationSpec: coreClient.OperationSpec = {
  ...
  urlParameters: [Parameters.region, Parameters.identifier, Parameters.datapointIdentifier],
  headerParameters: [Parameters.accept],
  serializer,
};
...
const listMappingDataSourceValuesOperationSpec: coreClient.OperationSpec = {
  ...
  queryParameters: [Parameters.offset, Parameters.limit, Parameters.search, Parameters.annotation],
  urlParameters: [Parameters.region, Parameters.identifier],
  headerParameters: [Parameters.accept],
  serializer,
};
...
const listMappingsOperationSpec: coreClient.OperationSpec = {
  ...
  queryParameters: [Parameters.offset, Parameters.limit, Parameters.mappingDataSource],
  urlParameters: [Parameters.region],
  headerParameters: [Parameters.accept],
  serializer,
};
...
const getAllTagsOperationSpec: coreClient.OperationSpec = {
  ...
  queryParameters: [Parameters.name, Parameters.offset, Parameters.limit, Parameters.workspace],
  urlParameters: [Parameters.region],
  headerParameters: [Parameters.accept],
  serializer,
};
...
const createOrganizationOperationSpec: coreClient.OperationSpec = {
  ...
  formDataParameters: [Parameters.name1, Parameters.avatar, Parameters.resthookSignatureKey],
  urlParameters: [Parameters.region],
  headerParameters: [Parameters.contentType1, Parameters.accept1],
  serializer,
};
...
const getAllOrganizationMembershipsOperationSpec: coreClient.OperationSpec = {
  ...
  queryParameters: [Parameters.offset, Parameters.limit, Parameters.organization1, Parameters.role],
  urlParameters: [Parameters.region],
  headerParameters: [Parameters.accept],
  serializer,
};
...
const getAllIndexesOperationSpec: coreClient.OperationSpec = {
  ...
  queryParameters: [Parameters.name, Parameters.offset, Parameters.limit, Parameters.documentType],
  urlParameters: [Parameters.region],
  headerParameters: [Parameters.accept],
  serializer,
};
